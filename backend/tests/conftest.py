"""Pytest fixtures shared by backend API integration tests."""
...
from .helpers import ApiClient, generate_test_image, require_backend_base_url, wait_for_job_completion
